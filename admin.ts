...
// TODO:
// - Реализовать сценарий для ответа "Нет"
// - Добавить процесс повторной регистрации
// - Добавить ссылку на курс
// - Реализовать логику завершения курса
// - Добавить информацию о цене курса
// - Стандартизировать формат даты рождения
// - Добавить обработку истечения времени на регистрацию
