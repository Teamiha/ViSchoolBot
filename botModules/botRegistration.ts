...
export async function botRegistration(ctx: MyContext) {
  ...
  await ctx.reply(
    "Начат процесс регистрации.\n" +
      "Пожалуйста, введите все данные и проведите оплату за обучение в течение 30 минут.\n" +
...
export async function botRegistrationExecute(ctx: MyContext) {
  ...
  await ctx.reply(
    "Спасибо! После подтверждения оплаты, вам придет сообщение о завершении регистрации. \n" +
